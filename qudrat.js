...
// const myReverseArr =(array)=>{
//     const arr = [];
//     for (let i = 0; i < array.length; i++) {
//     let a = '';
//     let b = array[i].toString().length;
//        for (let j = 0; j < b; j ++){
//            a += parseInt(array[i]) % 10;
...
//     console.log(arr);
// }
// myReverseArr([12,13,67,78])

// ------------------------------------------------------------------------

// const sonDaraja = (array) => {
//   for (let i = 0; i < array.length; i++) {
//     for (let j = 2; j < 50; j++) {             
//       Number.isInteger(array[i] ** (1 / j)) && console.log(`${array[i] ** (1 / j)} ning ${j} darajasi ${array[i]}`);
//     }
//   }
// };

// sonDaraja([81,27,12,4,10,77,8,36]);
